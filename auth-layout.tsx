  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        >
          <Link href="/">
            <h1 className="text-5xl font-bold neon-text tracking-tight">Lumina</h1>
            <p className="text-muted-foreground text-sm mt-2">Share your world</p>
          </Link>
        </motion.div>
